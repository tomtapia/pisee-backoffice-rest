...
public class RestDipreca {
	...
	public Response getConsultaImponentes(@QueryParam("rut") String rut, @QueryParam("dv") String dv, @QueryParam("pisee_token") String piseeToken) {
		...
		LOGGER.info(ConfigProveedoresServicios.SOAP_DIPRECA__CONSULTA_IMPONENTES + " - TIME == " + (endTime - startTime) + " MILISECONDS");
