...
public class RestModernizacion {
	...
	//-------
	@GET
	@Path("v1/pruebaServicioPost")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	public String pruebaServicioPost(@QueryParam("param01") String param01,
		...
		inputParameter.addBodyParameter("param01", param01);	
		inputParameter.addBodyParameter("param02", param02);	
		inputParameter.addBodyParameter(ParametersName.PISEE_TOKEN, piseeToken);
		
		respuesta = restBusiness.callService(ConfigProveedoresServicios.REST_PISEE__TEST_POST, inputParameter);
		String value = jsonUtil.toJSON(respuesta);		
		
		long endTime = System.currentTimeMillis();		
		LOGGER.info("pruebaServicioPost - TIME == " + (endTime - startTime) + " MILISECONDS");
	    return value;
    }	
	
	@GET
	@Path("v1/pruebaServicioPut")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	public String pruebaServicioPut(@QueryParam("param01") String param01,
									@QueryParam("param02") String param02,
		...
		inputParameter.addBodyParameter("param01", param01);	
		inputParameter.addBodyParameter("param02", param02);
		inputParameter.addBodyParameter("param03", param03);
		inputParameter.addBodyParameter(ParametersName.PISEE_TOKEN, piseeToken);
		
		respuesta = restBusiness.callService(ConfigProveedoresServicios.REST_PISEE__TEST_PUT, inputParameter);
		String value = jsonUtil.toJSON(respuesta);		
		
		long endTime = System.currentTimeMillis();		
		LOGGER.info("pruebaServicioPut - TIME == " + (endTime - startTime) + " MILISECONDS");
	    return value;
    }		
}
