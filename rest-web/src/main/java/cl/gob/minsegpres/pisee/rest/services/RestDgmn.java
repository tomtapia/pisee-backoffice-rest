...
public class RestDgmn {
	...
	public Response getConsultaSituacionMilitar(@QueryParam("rut") String rut, @QueryParam("dv") String dv, @QueryParam("pisee_token") String piseeToken) {
		...
		LOGGER.info(ConfigProveedoresServicios.SOAP_DGMN_SITUACION_MILITAR + " - TIME == " + (endTime - startTime) + " MILISECONDS");
